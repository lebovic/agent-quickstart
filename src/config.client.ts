...
const clientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_SESSION_FILES_ENABLED: z.string().default("false"),
})
...
const env = clientEnvSchema.parse({
  ...
  NEXT_PUBLIC_SESSION_FILES_ENABLED: process.env.NEXT_PUBLIC_SESSION_FILES_ENABLED,
})
...
export const clientConfig = {
  ...
  sessionFilesEnabled: env.NEXT_PUBLIC_SESSION_FILES_ENABLED === "true",
}
